...
<div class="flex flex-shrink-0 items-center">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="#" class=" text-dark rounded-md px-3 py-2 text-xs	 " aria-current="page">All topics</a>
            <a href="#" class="  hover:text-red rounded-md px-3 py-2 text-xs	 ">Help</a>
  ...
  <div>
                ...
                <label
                  for="default-search"
                  class="mb-2 text-sm font-small text-gray-900 sr-only dark:text-white"
                  >Search</label
                >
                <div class="relative">
                  <div
